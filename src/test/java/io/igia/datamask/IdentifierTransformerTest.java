...
public class IdentifierTransformerTest {
	...
	public void testDatamask() {
		...
		Transformer transformer = new IdentifierTransformer();
	...
	@Test
	public void testDatamaskRepeatMaskedIdentifierEqual() {
		String text = "This is a test.";
		Transformer transformer = new IdentifierTransformer();
		
		String maskedValue = transformer.mask(text);
		String secondMaskedValue = transformer.mask(text);
		assertTrue(maskedValue.equals(secondMaskedValue));
	}
